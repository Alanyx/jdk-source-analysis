 ...
 * For example, a reflective {@link Method Method} can
 ...
 * For example, {@link Method#getModifiers Method.getModifiers}
 * will report exactly those modifier bits required for any similarly
 * declared method, including in this case {@code native} and {@code varargs} bits.
 * <p>
 * As with any reflected method, these methods (when reflected) may be
 * invoked via {@link Method#invoke java.lang.reflect.Method.invoke}.
...
public abstract class MethodHandle {
     ...
     * {@link Method#invoke java.lang.reflect.Method.invoke}, via JNI,
     ...
     *     allowed by {@link Method#invoke java.lang.reflect.Method.invoke}.)
